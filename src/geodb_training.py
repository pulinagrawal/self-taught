...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_', type=float, default=0.003, help='multiplier for weight decay parameter')
    parser.add_argument('--momentum', type=float, default=0.8, help='gradient descent momentum')
