...
def preprocess(filename):
    ...
    """
    output_filename = filename[:-3]+'_preprocessed.pkl'
    ...
    plot_file = output_filename[:-3]+'_plot.svg'
    im.plot_genes(df.sample(1000)).savefig(plot_file, format='svg')
    ...
    # save scaled
    scaled_filename = output_filename[:-3]+'_scaled.pkl'
    plot_file = scaled_filename[:-3]+'_plot.svg'
    im.plot_genes(df.sample(1000)).savefig(plot_file, format='svg')
